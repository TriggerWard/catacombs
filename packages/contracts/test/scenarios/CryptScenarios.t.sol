...
contract CryptScenariosTest is CommonOptimisticOracleV3Test {
    ...
    // High volume of successful creations
    // Callback tests - Successes, overcomplicated callbacks, failure call backs
    // Huge array of crypts
    // Oracle liveliness failures

    // Stress tests
    // Duplicate/spam crypt creation
    // Assertion spaming
}
