...
Trigger Ward can be used for a wide range of applications where you want to _conditionally release data based on some real world action_. Some examples are:
